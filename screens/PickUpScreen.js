import { StyleSheet, Text,Alert, View, SafeAreaView, TextInput, Pressable, ScrollView } from 'react-native'
...
const PickUpScreen = () => {
  ...
  return (
    <>
    <SafeAreaView>
      <Text style={{marginTop: 30,fontSize:16, fontWeight:"500", marginHorizontal:10}}>Enter Address</Text>
      ...
      <Text style={{fontSize:16, fontWeight:"500", marginHorizontal:10 }}>Pick Up Date</Text>
        <HorizontalDatepicker
            mode="gregorian"
            startDate={new Date('2023-03-1')}
            endDate={new Date('2023-04-1')}
